        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-14">
          ...
          <div className="flex-1 flex flex-col gap-5 min-w-0">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-white border border-slate-300 text-slate-900 hover:border-black/60 hover:shadow-md font-bold text-sm rounded-xl transition-colors shadow-md mt-2"
